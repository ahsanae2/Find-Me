...
const [data, setData] = React.useState({
 ...
 if (!name){
  ...
  navigation.navigate('VerificationScreen', { phone :phone , name: name , checked: checked });
    ...
    return (
      ...
      <View style={styles.container}>
          ...
          <StatusBar barStyle="dark-content" backgroundColor="white"/>
           ...
           />
           <View style={tailwind`bg-white  h-12 mt-2 ml-4 mr-4 justify-center z-50 items-center rounded-lg `}>
