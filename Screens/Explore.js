...
import { View, StyleSheet, ActivityIndicator, TouchableOpacity, Text, Image, ScrollView, TextInput, Alert } from 'react-native';
...
<Loader visible={loading} />
            ...
            <View style={tailwind`flex-1`}>
                ...
                <ScrollView style={tailwind`flex-1`}>
                    ...
                    {lists?.filter((e)=>e.name.toLowerCase().includes(lowerCaseSongSearch)).map(user => (
                ...
                <TouchableOpacity  onPress={() => createGroup()} style={tailwind`bg-blue-500 w-16 h-16 rounded-full items-center justify-center shadow absolute bottom-4 right-4 z-50`}>
