...
import { collection, getFirestore,doc, setDoc, addDoc, updateDoc, deleteDoc, getDoc, getDocs, where, query ,onSnapshot, writeBatch} from "firebase/firestore";
  ...
  setModal(false)
   ...
   setLoading(true)
    ...
    try{
     ...
     let id = phoneProvider.verifyPhoneNumber(phone, recaptchaverifier.current)
      .then(
          setverificationid,       
    ...
    return (
      ...
      <Loader visible={loading} />
          ...
          <View style={tailwind`bg-white ml-4 mr-4 h-12 mt-2  justify-center  items-center rounded-lg `}>
        ...
        >
            ...
            <Text style={styles.text}>Enter the OTP number just sent you at: {phone}</Text>
