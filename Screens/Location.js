...
const Location = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      {distance !== 0 && time !== 0 && (
        <View
          style={tailwind`bg-white ml-14 mr-14 h-20 mt-2 justify-center z-50 items-center rounded-sm `}
        >
      ...
      >
        <View
          style={[
            tailwind`mt-32`,
            { flex: 0.39, justifyContent: "center", alignItems: "center" },
          ]}
        >
            ...
            <ScrollView>
              {records?.map((item) => (
                <View key={item.number} style={{ alignItems: "center" }}>
                  <TouchableOpacity
                    style={tailwind` py-2`}
                    onPress={() => filterExistingContacts(item)}
                  >
                    <Text
                      style={[
                        tailwind`text-black font-bold items-center justify-center`,
                        { fontSize: 16 },
                      ]}
                      numberOfLines={1}
                    >
                    ...
                    <Text
                      style={tailwind`text-gray-600 text-xs items-center justify-center`}
                      numberOfLines={1}
                    >
                      {item?.number}
                    </Text>
        ...
        >
          <View style={styles.modalView}>
            ...
            <ScrollView>
              ...
              {use === null && <Text>No one have car</Text>}
            </ScrollView>
            {/* <Pressable
              style={[styles.button, styles.buttonClose]}
              onPress={() => setModalVisible(!modalVisible)}>
